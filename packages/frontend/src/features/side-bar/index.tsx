...
import { pathExists, routeIsActive, RoutesId, routesView } from 'routing'
...
export const SideBar = () => {
	return (
		<div className={'side-bar'}>
			<Icon routeId={'controllerEditor'} title={'Редактор ии'}>
				<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
					<path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z" />
				</svg>
			</Icon>
			<Icon routeId={'mapEditor'} title={'Редактор карт'}>
			...
			<Icon routeId={'game'} title={'Запуск игры'}>
			...
			<Icon routeId={'replay'} title={'Просмотр реплеев'}>
				<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
const Icon = ({ children, routeId, title }: IconProps) => {
	const { page: currentPath = '' } = useUnit($locationSearch)
	const path = routesView.routes[routeId].path
	const active = routeIsActive(routeId, currentPath)
	return (
		<div
			onClick={() => historyMethods.appendParams({ page: path })}
