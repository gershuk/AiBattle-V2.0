...
import { pathIsActive } from '../routing'
import { clsx, createTranslation, $locationSearch } from 'libs'
import './styles.scss'
...
import { changeRoute, RoutePath } from 'model'
...
export const SideBar = () => {
	...
	return (
		<div className={'side-bar'} ref={sideBarRef}>
			<Icon
				routePath={RoutePath.controllerEditor}
				title={t('botCod')}
			...
			<Icon routePath={RoutePath.mapEditor} title={t('maps')}>
			...
			<Icon routePath={RoutePath.game} title={t('game')}>
...
const Icon = ({ children, routePath, title, htmlRef, ...props }: IconProps) => {
	...
	return (
		<div
			onClick={() => changeRoute(active ? null : routePath)}
